...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color appColor = const Color(0xFF4C2028);
  late Color appLightColor = const Color(0xFF714D54);
  late Color textColor = const Color(0xFF111827);
  late Color fillColor = const Color(0xFFECEDEE);
  late Color borderColor = const Color(0xFFEDF0F3);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color appColor = const Color(0xFFDA0A26);
  late Color appLightColor = const Color(0xFFB469F3);
  late Color textColor = const Color(0xFF0A2C2A);
  late Color fillColor = const Color(0xFF4EDC94);
  late Color borderColor = const Color(0xFF47045F);
}
